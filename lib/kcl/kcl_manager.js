...
KCLManager.prototype._onCheckpointAction = function(action) {
  ...
  checkpointer.onCheckpointerResponse.apply(checkpointer, [action.error, action.sequenceNumber, action.subSequenceNumber]);
};
 ...
 */
KCLManager.prototype.checkpoint = function(sequenceNumber, subSequenceNumber) {
  this._sendAction(this._context, {action : 'checkpoint', sequenceNumber : sequenceNumber, subSequenceNumber : subSequenceNumber});
};
