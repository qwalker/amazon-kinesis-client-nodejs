 ...
 */
Checkpointer.prototype.checkpoint = function(sequenceNumber, subSequenceNumber, callback) {
  ...
  this._kclManager.checkpoint(sequenceNumber, subSequenceNumber);
};
 ...
 * @ignore
 */
Checkpointer.prototype.onCheckpointerResponse = function(err, sequenceNumber, subSequenceNumber) {
  var callback = this._callback;
  this._callback = null;
  callback(err, sequenceNumber, subSequenceNumber);
};
